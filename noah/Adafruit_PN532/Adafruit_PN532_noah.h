...
#ifndef ADAFRUIT_PN532_NOAH_H
#define ADAFRUIT_PN532_NOAH_H
...
public:
  ...
  bool P2PInitiator_Init();
  bool P2PTarget_Init();
  bool P2PInitiator_TxRx(uint8_t *t_buffer, uint8_t t_length, uint8_t *r_buffer, uint8_t *r_length);
  bool P2PTarget_TxRx(uint8_t *t_buffer, uint8_t t_length, uint8_t *r_buffer, uint8_t *r_length);
